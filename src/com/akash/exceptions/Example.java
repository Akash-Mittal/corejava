...
/*
 Finally is useful for more than just exception handling — it allows
 the programmer to avoid having cleanup code accidentally 
 ...
 Finally will only not execute when
 	Jvm crashes
